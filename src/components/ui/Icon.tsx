...
type IconName = 'heart' | 'hand' | 'gift' | 'users' | 'facebook' | 'instagram' | 'youtube' | 'menu' | 'close' | 'arrow' | 'mail' | 'phone' | 'map'
...
export function Icon({ name, className = 'h-5 w-5' }: IconProps) {
  ...
  const filled = ['heart', 'facebook', 'instagram', 'youtube'].includes(name)
